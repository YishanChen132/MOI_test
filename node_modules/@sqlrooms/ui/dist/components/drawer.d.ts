...
declare function DrawerHandle({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Handle>): import("react/jsx-runtime").JSX.Element;
...
declare function DrawerContent({ className, overlayClassName, children, ...props }: React.ComponentProps<typeof DrawerPrimitive.Content> & {
