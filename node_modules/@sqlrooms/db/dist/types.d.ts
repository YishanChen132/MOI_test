 ...
 */
export declare const RuntimeSupport: z.ZodEnum<{
    browser: "browser";
    server: "server";
    both: "both";
}>;
 ...
 * postgres, snowflake).
 */
export declare const DbEngineId: z.ZodString;
/**
 ...
 */
export declare const CoreMaterializationStrategy: z.ZodEnum<{
    schema: "schema";
    attached_ephemeral: "attached_ephemeral";
}>;
/**
 * Strategy used when materializing external connector results into core DuckDB.
 */
export type CoreMaterializationStrategy = z.infer<typeof CoreMaterializationStrategy>;
/**
 * Configuration for how non-core results are stored in core DuckDB.
 */
export declare const CoreMaterializationConfig: z.ZodObject<{
    strategy: z.ZodDefault<z.ZodEnum<{
        schema: "schema";
        attached_ephemeral: "attached_ephemeral";
    }>>;
    schemaName: z.ZodDefault<z.ZodString>;
    attachedDatabaseName: z.ZodDefault<z.ZodString>;
}, z.core.$strip>;
/**
 * Configuration for how non-core results are stored in core DuckDB.
 */
export type CoreMaterializationConfig = z.infer<typeof CoreMaterializationConfig>;
/**
 * Declarative connection metadata used by the orchestration layer.
 */
export declare const DbConnection: z.ZodObject<{
    id: z.ZodString;
    engineId: z.ZodString;
    title: z.ZodString;
    runtimeSupport: z.ZodDefault<z.ZodEnum<{
        browser: "browser";
        server: "server";
        both: "both";
    }>>;
    requiresBridge: z.ZodDefault<z.ZodBoolean>;
    bridgeId: z.ZodOptional<z.ZodString>;
 ...
 */
export type DbConnector = Pick<DuckDbConnector, 'initialize' | 'destroy' | 'execute' | 'query' | 'queryJson'> & {
