...
function getXAxis(domain, width, isEnlarged, timezone, timeFormat) {
  ...
  var tickFormat = timeFormat ? (0, _utils.datetimeFormatter)(timezone)(timeFormat) : timezone ? getTickFormat(timezone) : null;
...
function TimeSliderMarkerFactory() {
  var TimeSliderMarker = function TimeSliderMarker(_ref) {
    ...
    var xAxis = (0, _react.useMemo)(function () {
      return getXAxis(domain, width, isEnlarged, timezone, timeFormat);
    }, [domain, width, isEnlarged, timezone, timeFormat]);
